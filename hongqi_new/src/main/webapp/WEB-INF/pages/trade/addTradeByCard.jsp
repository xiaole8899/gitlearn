...
<div class="pageContent">
	<form method="post" action="${CTX }/trade/getByCardwholesalerId.do" class="pageForm required-validate" id="addTrade" onsubmit="return validateCallback(this,navTabAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			<input type="hidden" name="buyerType" value="1" />
			<p>
			 	<label>卖方卡号：</label> 
			 	<!-- 卖方备案号 -->
			 	<input type="text" readonly="readonly" style="color: green;"  name="sellerCardNo" value=""/>
	            ...
	            <table class="list nowrap itemDetail"   addButton="增加商品明细" width="60%" >
					<thead>
						<tr>
							...
							lookupurl="${CTX }/approach/findGoods.do"  lookupPk="goodsCode"
