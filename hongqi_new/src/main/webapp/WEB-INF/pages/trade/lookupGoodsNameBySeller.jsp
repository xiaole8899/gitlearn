...
<div class="pageHeader">
	 <form rel="pagerForm" onsubmit="return dialogSearch(this);" action="${CTX }/trade/findGoods.do?approachStateAdd=${approachState}" method="post">
		 <div class="searchBar">
...
<div class="pageContent">
	...
	<%-- 分页查询的Form --%>
	<form id="pagerForm" action="${CTX }/trade/findGoods.do?approachStateAdd=${approachState}"
	 method="post">
