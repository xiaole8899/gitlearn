...
<div class="pageContent">
	<form method="post" action="${CTX }/trade/getWholesalerId.do" class="pageForm required-validate" id="addTrade" onsubmit="return validateCallback(this,navTabAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			<p>
				...
				<input type="text" size="25"  readonly="readonly" class="required" name="bizLookup.bizName" value="" suggestFields="" suggestUrl="${CTX }/trade/findMerchant.do" lookupGroup="bizLookup" />
		...
		<%-- 	<p >
				<label>买方类型：</label>
				<select class="combox " name="buyerType" id="add-trade-buyerType">
			...
			<p>
				<label>买方名称：</label>
				<input type="text"  name="retailerName" size="25"/>
			</p>
			
			<p style="margin-left: 20%;display: none;" id="add-trade-retailerId">
				<label>买家编码：</label>
				<input type="text"  name="retailerId" size="25"/>
            ...
            <p style="margin-left: 20%">
				<label>交易日期：</label>
				<input type="text" name="tranDate1" class=" date" dateFmt="yyyy-MM-dd HH:mm:ss" readonly="true" size="22"/>
           ...
           <!--  <div class="divider" style="display: none;" id="add-trade-tradeTypeDivider"></div>
			...
			<%-- <div class="unit" style="margin-top: 40px;">
	            <table class="list nowrap itemDetail" addButton="增加商品明细" width="60%" >
					<thead>
						<tr>
							<th size="30" fieldclass="required"  width="500"   id="lookup"
							lookupurl="${CTX }/trade/findGoods.do"  lookupPk="goodsCode"
		 ...
		 <div class="formBar">
			<ul>
				<li><div class="buttonActive"><div class="buttonContent"><button type="submit" id="addMerchant">加载卖方进场数据</button></div></div></li>
				<li>
...
/* $(document).ready(function(){
    $("#addTradeData").click(function() {
    	var $wholesalerId =$("#sdd").val(); 
    	alert($wholesalerId); 
   		var $funck=$("#lookup").find("lookupurl").val();
    	alert($funck);
