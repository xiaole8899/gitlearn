...
<div class="pageContent">
	<form method="post" action="${CTX }/user/doPersonalEdit.do" rel="userdoPersonalEdit" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			...
			<p>
				<label>联系电话：</label>
				<input type="text" class="phone" name="telephone" value="${user.telephone}" size="30" />
			</p>
			<p>
				<label>电子邮箱：</label>
