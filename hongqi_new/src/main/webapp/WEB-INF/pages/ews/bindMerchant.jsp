...
<div class="pageContent">
	<form method="post" action="${CTX }/ews/doBindMerchant.do" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<input type="hidden" id="ewsBackId"  name="ewsBackId" value="${ewsBackId}">
						...
						<tr>
							<td align="center">
								<input type="radio" id="bizNumber" name="bizNumber"
									<c:if test="${merall.bizNo==ewsBack.salerNumber}"> checked="checked" </c:if>
								 value="${merall.bizNo}"  />
							</td> 
