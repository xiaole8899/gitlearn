...
<div class="pageContent">
	<form method="post" action="${CTX }/ews/doUpdateNotice.do" class="pageForm required-validate" rel="dfghjkl" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="56">
		    <input type="hidden" name="noticeId" value="${notice.noticeId}">
			
			<p>
				<label>公告时间：</label>
				<input type="text" name="date" class="date" dateFmt="yyyy-MM-dd HH:mm:ss" readonly="true" size="28" value="<fmt:formatDate value="${notice.ctime }" pattern="yyyy-MM-dd 
HH:mm:ss"/>"/>
			...
			<p>
				<label>公告内容：</label>
				<%-- <input type="text" class="required" name="content" value="${notice.content}" size="30" /> --%>
