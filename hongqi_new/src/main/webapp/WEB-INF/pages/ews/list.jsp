...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="${CTX }/ews/listEws.do" method="post">
		<div class="searchBar">
			<table class="searchContent">
				<tr>
					<td>电子秤IP地址：<input type="text" class="checkReset" name="ewsIp" value="${ews.ewsIp }" /></td>
					<td>绑定商户名称：<input type="text" class="checkReset" name="salerName" value="${ews.salerName }" /></td>
					<td>绑定商户编号：<input type="text" class="checkReset" name="salerNumber"  /></td>
				</tr>
				<tr>
					<td>绑定时间：
					    <input type="text" name="statrdate" class="date checkReset " dateFmt="yyyy-MM-dd HH:mm:ss" readonly="true" size="20" style="margin-left: 20px" />
					    <a class="inputDateButton" href="javascript:;" style="float:right;">选择</a>
					</td>
					<td>至
					    <input type="text" name="enddate" class="date checkReset " dateFmt="yyyy-MM-dd HH:mm:ss" readonly="true" size="20" style="margin-left: 68px" />
					    <a class="inputDateButton" href="javascript:;" style="float:right;">选择</a>
					</td>
				</tr> 
			</table>
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="${CTX }/ews/toAddEws.do" target="dialog" rel="ewstoadd"><span>添加电子秤</span></a></li>
			<li><a class="edit" href="${CTX }/ews/toUpdateEws.do?ewsId={ews_id}" target="dialog"><span>修改电子秤</span></a></li>
			<li><a class="delete" href="${CTX }/ews/deleteEws.do?ewsId={ews_id}" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
			<%-- <li><a class="icon" href="${CTX }/ews/toBindFec.do?ewsId={ews_id}" target="dialog" title="绑定前置机"><span>绑定前置机</span></a></li> --%>
		</ul>
	</div>
	<%-- 数据列表 --%>
	...
	<%-- 分页查询的Form --%>
	<form id="pagerForm" action="${CTX }/ews/listEws.do" method="post">
