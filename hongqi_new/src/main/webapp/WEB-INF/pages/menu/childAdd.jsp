...
<div class="pageContent">
	<form method="post" action="${CTX}/menu/doChildAdd.do?flag=${parentId}" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			...
			<p>
				...
				<input type="text" class="required" size="30" maxlength="80" name="url" size="30" />
			</p>
			<p>
				<label>标签名：</label>
				<input type="text" class="required"  name="rel" maxlength="40" size="30" />
			</p>
			<p>
				<label>描述：</label>
