...
<div class="pageContent">
	<form method="post" action="${CTX }/ic/doAddIc.do" class="pageForm required-validate" rel="dfghjkl" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			<p>
				<label>IC读写器名称：</label>
				<input type="text" class="checkReset" name="icName" size="30"/>
			</p>
			<p>
				<label>时间：</label>
